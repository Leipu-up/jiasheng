...
Page({
    ...
    loadData() {
        ...
        //  调用后台接口
        api.getCljcList(params).then(responseData => {
            wx.hideLoading();
    ...
    saveAddInfo() {
        ...
        const saveData = {
            ...
            phsl: addFormData.phsl.trim(),
            lh: addFormData.lh.trim(), // 炉号
            srr: addFormData.srr.trim(), // 受入日
            jcr: addFormData.jcr.trim(), // 检查日
            czzm: addFormData.czzm.trim(), // 材质证明
            rohs: addFormData.rohs.trim(), // TOHS
            chbg: addFormData.chbg.trim(), // 出货报告
            rq: rq,
            jyy: {
                id: userInfo.userId
            },
        ...
        //  调用后台接口
        api.saveCljc(saveData).then(responseData => {
            wx.hideLoading();
