...
Page({
    ...
    loadData() {
        ...
        //  调用后台接口
        api.getCljcjgbWorkList(params).then(responseData => {
            wx.hideLoading();
    ...
    onRowClick(e) {
        ...
        wx.navigateTo({
            url: `/pages/cljcDetail/cljcDetail?cacheKey=${cacheKey}`,
        });
    },
    ...
    deleteRecord(id) {
        ...
        //  调用后台接口
        api.deleteCljcjgbWork(saveData).then(responseData => {
            wx.hideLoading();
            wx.showToast({
                title: '删除成功',
                icon: 'success',
    ...
    saveEditInfo() {
        ...
        //  调用后台接口
        api.updateCljcjgbWork(jjgxjcbEntity).then(responseData => {
            wx.hideLoading();
            wx.showToast({
                title: '修改成功',
                icon: 'success',
