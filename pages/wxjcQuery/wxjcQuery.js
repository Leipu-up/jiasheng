...
Page({
    ...
    loadData() {
        ...
        //  调用后台接口
        api.getWxjcList(params).then(responseData => {
            wx.hideLoading();
    ...
    saveAddInfo() {
        ...
        const saveData = {
            ...
            ccslwg: addFormData.ccslwg.trim(),
            ccslcc: addFormData.ccslcc.trim(),
            rq: rq,
            jyy: {
                id: userInfo.userId
            },
        ...
        //  调用后台接口
        api.saveWxjc(saveData).then(responseData => {
            wx.hideLoading();
