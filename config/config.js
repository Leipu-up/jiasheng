...
const API_CONFIG = {
    ...
    // 生产环境
    [ENV.PROD]: {
        BASE_URL: 'https://812ag067mz42.vicp.fun',
        API_PREFIX: '/wechat',
        TIMEOUT: 30000, // 30秒
        DEBUG: false
    }
...
API.ENDPOINTS = {
    ...
    WORK: {
        ...
        DETAILLIST: '/work/getWorkListPage', // 获取工作详情
        ...
        SAVEJJGXJCDJB: '/work/saveJjgxjcdjb' // 更新检查刀具表
    },
    ...
    // 外协检查相关
    WXJC: {
        LIST: '/wxjc/getPage', // 获取产品列表
        DETAIL: '/wxjc/detail', // 获取产品详情
        SEARCH: '/wxjc/search', // 搜索产品
        SAVE: '/wxjc/saveOne', // 保存工序检查表
        WXJCJGBLIST: '/wxjcjgb/getPage', // 获取工作列表
        WXJCJGBDETAILLIST: '/wxjcjgb/getWorkListPage', // 获取工作详情
        WXJCJGBCREATE: '/wxjcjgb/saveOne', // 创建工序详情表
        WXJCJGBUPDATE: '/wxjcjgb/updateWorkOne', // 更新工序表
        WXJCJGBDELETE: '/wxjcjgb/deleteWorkOne', // 删除工序表
        WXJCJGBJJGXJCJGBLIST: '/wxjcjgb/getJjgxjcjgbList',
        WXJCJGBSAVEJJGXJCJGB: '/wxjcjgb/saveJjgxjcjgb', // 更新检查结果表
